#!/usr/bin/env python3
"""
QBM Academic Research Test Script
==================================
...
5. ربط القلب بالسلوك وأنماط الشخصية
"""
...
def run_academic_test():
    ...
    print("=" * 80)
    print("QBM ACADEMIC RESEARCH TEST")
    print("=" * 80)
    ...
    try:
        ...
        output = {
            ...
            "system_prompt_summary": "Academic Islamic Scholar with QBM Data",
            "response": answer,
            "tokens_used": {
        ...
        # Save JSON
        with open("qbm_academic_test_result.json", "w", encoding="utf-8") as f:
            json.dump(output, f, ensure_ascii=False, indent=2)
        
        # Save Markdown
        with open("qbm_academic_test_result.md", "w", encoding="utf-8") as f:
            f.write(f"# نتائج البحث الأكاديمي - مشروع QBM\n\n")
            ...
            f.write(answer)
            f.write("\n\n---\n\n")
            f.write("*تم إنشاء هذا التقرير آلياً بواسطة نظام QBM للبحث الأكاديمي*\n")
        
        print("\n✅ Results saved to:")
        print("   - qbm_academic_test_result.json")
        print("   - qbm_academic_test_result.md")
...
def run_interactive_test():
    """Run an interactive version with streaming."""
    
    print("=" * 80)
    print("QBM ACADEMIC RESEARCH TEST (STREAMING)")
    print("=" * 80)
    ...
    try:
        ...
        print("\n✅ Results saved to: qbm_academic_test_result.md")
...
if __name__ == "__main__":
    ...
    if not API_KEY:
        ...
        print("  python test_academic_query.py")
        sys.exit(1)
